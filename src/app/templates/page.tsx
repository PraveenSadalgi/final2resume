        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground mt-3 max-w-2xl mx-auto">
              Select a template that best showcases your experience and skills. All templates are ATS-friendly.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16">
            {allTemplates.map((templateData) => {
              ...
              return (
                <div key={templateData.template} className="group flex flex-col items-center gap-6">
                    <Card className="w-full max-w-[540px] overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 ease-in-out border-2 border-transparent hover:border-primary transform hover:-translate-y-2">
                      <CardContent className="p-0">
                         <div className="w-full aspect-[8.5/11] overflow-hidden bg-white">
                           <div className="transform scale-[0.65] origin-top mx-auto transition-transform duration-300 ease-in-out group-hover:scale-[0.68]">
